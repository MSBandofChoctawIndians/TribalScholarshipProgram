...
export default function Page() {
  return (
    <>
      <header className="relative flex items-center justify-center min-h-[25rem] h-[85vh] w-full mb-12 overflow-hidden">
        <video
          autoPlay
          loop
          muted
          playsInline
          className="absolute z-10 top-1/2 left-1/2 min-w-full min-h-full w-auto h-auto -translate-x-1/2 -translate-y-1/2 max-w-none"
        >
